SVG = {
    ...
    arcText: function (content, cx, cy, r, start, end, fontsize, args = {}) {
        ...
        text += "<text><textPath startOffset=\"50%\" text-anchor=\"middle\" alignment-baseline=\"middle\" lengthAdjust=\"spacingAndGlyphs\" font-size=\"" + fontsize + "\" textLength=\"" + textLength + "\" href=\"#ArcID" + this.arctextId + "\" ";
        for (key in args) {
            text += key + "=\"" + args[key] + "\" ";
        }
